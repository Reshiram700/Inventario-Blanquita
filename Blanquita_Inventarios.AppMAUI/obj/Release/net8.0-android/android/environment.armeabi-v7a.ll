...
@dso_cache = dso_local local_unnamed_addr global [824 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 91402535, ; hash 0x572b127, from name: aot-Blanquita_Inventarios.AppMAUI
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 445393611, ; hash 0x1a8c2acb, from name: Blanquita_Inventarios.AppMAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 71
	...
	%struct.DSOCacheEntry {
		i64 1066855702, ; hash 0x3f96ed16, from name: Blanquita_Inventarios.Entities.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1083586446, ; hash 0x4096378e, from name: libaot-Blanquita_Inventarios.AppMAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 192
	...
	%struct.DSOCacheEntry {
		i64 1305750175, ; hash 0x4dd42a9f, from name: Blanquita_Inventarios.AppMAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 231
	...
	%struct.DSOCacheEntry {
		i64 1417110036, ; hash 0x54776214, from name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 260
	...
	%struct.DSOCacheEntry {
		i64 1455487298, ; hash 0x56c0f942, from name: Controls.UserDialogs.Maui.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1783641731, ; hash 0x6a503683, from name: Blanquita_Inventarios.Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Blanquita_Inventarios.Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 321
	...
	%struct.DSOCacheEntry {
		i64 2091965221, ; hash 0x7cb0db25, from name: aot-Blanquita_Inventarios.Entities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Blanquita_Inventarios.Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 2305295330, ; hash 0x896803e2, from name: libaot-Blanquita_Inventarios.Entities.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Blanquita_Inventarios.Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 437
	...
	%struct.DSOCacheEntry {
		i64 2584916587, ; hash 0x9a12b26b, from name: aot-Blanquita_Inventarios.Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Blanquita_Inventarios.Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 490
	...
	%struct.DSOCacheEntry {
		i64 2661789361, ; hash 0x9ea7aeb1, from name: libaot-Blanquita_Inventarios.Entities
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Blanquita_Inventarios.Entities.dll.so
		ptr null; void* handle (0x0)
	}, ; 502
	...
	%struct.DSOCacheEntry {
		i64 2833906405, ; hash 0xa8e9fae5, from name: Controls.UserDialogs.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Controls.UserDialogs.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 535
	...
	%struct.DSOCacheEntry {
		i64 2933235592, ; hash 0xaed59f88, from name: aot-Controls.UserDialogs.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Controls.UserDialogs.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 553
	...
	%struct.DSOCacheEntry {
		i64 3167839706, ; hash 0xbcd165da, from name: libaot-Controls.UserDialogs.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Controls.UserDialogs.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 608
	...
	%struct.DSOCacheEntry {
		i64 3441461321, ; hash 0xcd208849, from name: aot-Blanquita_Inventarios.AppMAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Blanquita_Inventarios.AppMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 660
	...
	%struct.DSOCacheEntry {
		i64 3464743068, ; hash 0xce83c89c, from name: aot-Controls.UserDialogs.Maui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Controls.UserDialogs.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 665
	...
	%struct.DSOCacheEntry {
		i64 4167976733, ; hash 0xf86e471d, from name: libaot-Controls.UserDialogs.Maui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Controls.UserDialogs.Maui.dll.so
		ptr null; void* handle (0x0)
	}, ; 798
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [166 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
