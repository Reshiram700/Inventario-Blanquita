...
@dso_cache = dso_local local_unnamed_addr global [522 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 105053749, ; hash 0x642fe35, from name: Blanquita_Inventarios.PrototipoMAUI.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 783244850, ; hash 0x2eaf5e32, from name: aot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 82
	...
	%struct.DSOCacheEntry {
		i64 1139816333, ; hash 0x43f0378d, from name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 2986122966, ; hash 0xb1fc9ed6, from name: aot-Blanquita_Inventarios.PrototipoMAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 3778259963, ; hash 0xe133abfb, from name: Blanquita_Inventarios.PrototipoMAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 456
	...
	%struct.DSOCacheEntry {
		i64 4166826348, ; hash 0xf85cb96c, from name: libaot-Blanquita_Inventarios.PrototipoMAUI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Blanquita_Inventarios.PrototipoMAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 508
